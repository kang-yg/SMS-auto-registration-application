...
public class NotificationHelper extends ContextWrapper {
  ...
  /*  public NotificationManager getNotificationManager(){
    ...
    public void notify(String message, String number) {
        ...
        parsingStr = smsParsing.checkNumber(number, message);
        ...
        intent01.putExtra("Title", parsingStr.get(1));
        intent01.putExtra("Date", parsingStr.get(0));
        ...
        PendingIntent pendingIntent02 = PendingIntent.getActivity(this, 1, new Intent(this, Login.class), PendingIntent.FLAG_UPDATE_CURRENT);
